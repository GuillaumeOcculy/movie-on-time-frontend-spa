<template>
  <div>
    <h1>Privacy Policy for Movie On Time</h1>

    <p>
      At Movie On Time, accessible from www.movieontime.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Movie On
    ...
    <p>
      ...
      contact@movieontime.com
    </p>

    <h2>Log Files</h2>

    <p>
      Movie On Time follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Movie On Time uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertisements and links that appear on Movie On Time, which are sent
    ...
    <p>
      Note that Movie On Time has no access to or control over these cookies
    ...
    <p>
      Movie On Time's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Movie On Time does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in Movie On Time. This policy is not applicable to any
