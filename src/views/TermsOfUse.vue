<template>
  <div>
    ...
    <p>
      The Movie On Time website located at www.movieontime.com is a copyrighted
      work belonging to Movie On Time. Certain features of the Site may be
      subject to additional guidelines, terms, or rules, which will be posted on
    ...
    <p>
      <strong>Cookies and Web Beacons.</strong> Like any other website, Movie On
      Time uses ‘cookies’. These cookies are used to store information including
    ...
    <p>
      ...
      should be sent to: Paris, France. After the Notice is received, you and
      the Company may attempt to resolve the claim or dispute informally. If you
    ...
    <p>
      Email:
      <a href="mailto:contact@movieontime.com" target="_top"
        >contact@movieontime.com</a
      >
    </p>
  </div>
</template>
